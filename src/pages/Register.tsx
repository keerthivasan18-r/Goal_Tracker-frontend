...
import { Target, Lock, Mail, User as UserIcon, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md glass-panel rounded-2xl p-8 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-wider gradient-text">CREATE ACCOUNT</h2>
          <p className="text-slate-400 text-xs mt-1">Get started with your custom Goal Tracker</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <UserIcon className="absolute left-3 top-3 h-4.5 w-4.5 text-slate-500" />
              <input
                type="text"
          ...
          <button
            ...
            className="w-full mt-6 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 disabled:bg-blue-800 disabled:text-slate-400 text-white font-bold text-sm transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer shadow-[0_4px_20px_rgba(59,130,246,0.3)]"
          >
            {isSubmitting ? (
              <>
